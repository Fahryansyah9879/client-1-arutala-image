...
const services = [
  {
    title: "Wedding",
    description: "Full-day coverage of your celebration, from preparation to the last dance",
  },
  {
    title: "Engagement",
    description: "Intimate sessions capturing the essence of your connection",
  },
  {
    title: "Pre-Wedding",
    description: "Cinematic storytelling in stunning destinations worldwide",
  },
  {
    title: "Elopement",
    description: "Adventurous documentation for couples who dare to dream differently",
  },
];
