  ...
  return (
    ...
    >
      <nav className='container mx-auto px-4 md:px-6 flex items-center justify-between'>
        <a
          href='#hero'
          className={`font-serif text-lg md:text-xl tracking-wide hover:opacity-70 transition-all duration-300 ${
        ...
        <a
          href='#contact'
          className={`font-sans text-xs md:text-sm tracking-widest uppercase border px-4 py-2 md:px-6 md:py-2.5 transition-all duration-400 ${
            scrolled
